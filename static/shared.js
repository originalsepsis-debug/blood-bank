...
// V6.4.39: звіт за замовчуванням відкривається на поточний місяць, а не на старий тестовий місяць.
...
async function loadHomeStatusV6424(){
  try{ const h=await jget('/api/health'); updateHomeSystemStatusV6424(h); }catch(e){
    updateHomeSystemStatusV6424({ok:false,version:'V6.4.39',database_status_label:'❌ Недоступно',database_type:'—',backup_status_label:'—',telegram_status_label:'—'});
  }
}
...
async function loadAll(){
  // V6.4.39: легке оновлення. Не вантажимо всі 20+ API кожні 5 секунд.
...
// V6.4.39: остаточна видимість розділів у браузері та PWA.
...
// V6.4.39 FINAL ROLE CLEANUP: прибирає зайві панелі для doctor/nurse у браузері та PWA.
(function(){
...
// V6.4.39: doctor/nurse мають право списувати тільки власні погоджені/видані вимоги.
