...
async function loadAll(){
  // V6.4.21: легке оновлення. Не вантажимо всі 20+ API кожні 5 секунд.
...
// V6.4.21: остаточна видимість розділів у браузері та PWA.
...
// V6.4.21 FINAL ROLE CLEANUP: прибирає зайві панелі для doctor/nurse у браузері та PWA.
(function(){
...
// V6.4.21: doctor/nurse мають право списувати тільки власні погоджені/видані вимоги.
