...
function show(id){
  ...
  if(id==='backupSec'&&typeof loadBackupsV613==='function')loadBackupsV613();
  if(id==='usersSec'&&typeof loadUsersPanel==='function')loadUsersPanel();
  if(id==='dashboardProSec'&&typeof loadHome==='function')loadHome();
  return true;
}
...
async function loadAll(){
  const tasks=[];
  if(typeof loadStock==='function')tasks.push(loadStock());
  if(typeof loadRequestsLive==='function')tasks.push(loadRequestsLive());
  if(typeof loadReminders==='function')tasks.push(loadReminders());
  if(typeof loadUsersPanel==='function')tasks.push(loadUsersPanel());
  if(typeof loadAudit==='function')tasks.push(loadAudit());
  if(typeof loadAlerts==='function')tasks.push(loadAlerts());
  if(typeof loadTrash==='function')tasks.push(loadTrash());
  if(typeof loadBackups==='function')tasks.push(loadBackups());
  if(typeof loadHome==='function')tasks.push(loadHome());
  if(typeof loadTransfusionJournal==='function')tasks.push(loadTransfusionJournal());
  if(typeof loadReactionRegistry==='function')tasks.push(loadReactionRegistry());
  if(typeof loadTransfusionEvents==='function')tasks.push(loadTransfusionEvents());
  if(typeof loadTelegramStatus==='function')tasks.push(loadTelegramStatus());
  await Promise.allSettled(tasks);
  try{loadHomeQuickInfo();}catch(e){}
  try{updatePWAStatus();}catch(e){}
  try{await applyRoleVisibilityV613();}catch(e){}
  try{await loadComponentStockV613();}catch(e){}
  try{if(typeof loadBackupsV613==='function')await loadBackupsV613();}catch(e){}
}
