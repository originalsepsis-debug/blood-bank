...
function canWriteoffRequestUI(x, tab='active'){
  ...
  // V6.4.65: списання вимоги є тільки для вже виданого компонента.
...
async function loadHomeStatusV6424(){
  try{ const h=await jget('/api/health'); updateHomeSystemStatusV6424(h); }catch(e){
    updateHomeSystemStatusV6424({ok:false,version:'V6.4.65',database_status_label:'❌ Недоступно',database_type:'—',backup_status_label:'—',telegram_status_label:'—'});
  }
}
