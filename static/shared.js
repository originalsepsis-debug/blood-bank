...
async function loadTelegramMe(){
  ...
  const allowed=d.allowed_notifications || (['admin','transfusion'].includes(role)?['new_requests','critical','expiring','reactions']:(role==='admin'?['new_requests','critical','expiring','reactions','backups']:['new_requests']));
...
async function loadAll(){
  // V6.4.11: легке оновлення. Не вантажимо всі 20+ API кожні 5 секунд.
...
// V6.4.11: остаточна видимість розділів у браузері та PWA.
