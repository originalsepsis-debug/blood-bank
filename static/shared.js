...
async function loadAll(){
  // V6.4.10: легке оновлення. Не вантажимо всі 20+ API кожні 5 секунд.
...
// V6.4.10: остаточна видимість розділів у браузері та PWA.
