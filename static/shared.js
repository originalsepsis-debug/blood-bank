...
async function issueComponentStockV6422(idx){
  ...
  if(qty===null)return;
  const r=await jpost('/api/component-stock/issue',{component:x.component, donor_group:x.donor_group, donor_rh:x.donor_rh, qty, request_id});
...
async function writeoffComponentStockV6422(idx){
  ...
  const r=await jpost('/api/component-stock/writeoff',{component:x.component, donor_group:x.donor_group, donor_rh:x.donor_rh, qty, request_id, reason});
