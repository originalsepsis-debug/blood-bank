Blood Bank V7.4.3 — Bugfix Validation UI Audit

# Blood Bank V7.4.3 — Security UI Polish

Чиста модульна версія банку крові. V7.4.3 — фінальне полірування безпеки: trace-кнопки без unit_code в inline JS, валідація дат, temperature roles, nurse_user_id і DB login rate-limit.
...
- Оновлено версію, manifest і service worker cache до V7.4.3.
...
- Оновлено PWA cache і manifest до 7.4.3.
