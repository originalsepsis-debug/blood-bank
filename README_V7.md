Blood Bank V7.4.2 — Bugfix Validation UI Audit

# Blood Bank V7.4.2 — Security UI Polish

Чиста модульна версія банку крові. V7.4.2 — фінальне полірування безпеки: trace-кнопки без unit_code в inline JS, валідація дат, temperature roles, nurse_user_id і DB login rate-limit.
...
- Оновлено версію, manifest і service worker cache до V7.4.2.
...
## V7.4.2 RENDER_PYTHON_VERSION_FIX
...
- Оновлено PWA cache і manifest до 7.4.2.
